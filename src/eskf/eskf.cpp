...
void ESKF::predict_covariance(const Vector3f &w, const Vector3f &a) {
    ...
    //        + ez * P66 * ez' * dt^2          (乘法: 12, 加法: 48)
    _cov[3][3] += -(XP32[0][0] + XP32[0][0] + RP52[0][0] + RP52[0][0])
                    + (XP33XT00 + RP53XT[0][0] + RP53XT[0][0] + RP55RT00);
    _cov[3][4] += -(XP32[0][1] + XP32[1][0] + RP52[0][1] + RP52[1][0])
                    + (XP33XT01 + RP53XT[0][1] + RP53XT[1][0] + RP55RT01);
    _cov[3][5] += (_cov[15][3] * _dt - XP32[0][2] - XP32[2][0] - RP52[0][2] - RP52[2][0])
                    + (XP33XT02 + RP53XT[0][2] + RP53XT[2][0] + RP55RT02 - (XP36[0] + RP56[0]) * _dt);
    _cov[4][4] += -(XP32[1][1] + XP32[1][1] + RP52[1][1] + RP52[1][1])
                    + (XP33XT11 + RP53XT[1][1] + RP53XT[1][1] + RP55RT11);
    _cov[4][5] += (_cov[15][4] * _dt - XP32[1][2] - XP32[2][1] - RP52[1][2] - RP52[2][1])
                    + (XP33XT12 + RP53XT[1][2] + RP53XT[2][1] + RP55RT12 - (XP36[1] + RP56[1]) * _dt);
    _cov[5][5] += ((_cov[15][5] + _cov[15][5]) * _dt - XP32[2][2] - XP32[2][2] - RP52[2][2] - RP52[2][2])
                    + (XP33XT22 + RP53XT[2][2] + RP53XT[2][2] + RP55RT22 + _cov[15][15] * _dt2 - (XP36[2] + XP36[2] + RP56[2] + RP56[2]) * _dt);
